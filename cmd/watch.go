...
func init() {
	...
	watchCommand.Flags().BoolVar(&watchOutputConfig.HideDate, "hideDate", false, "Hides timestamp prefix")
	watchCommand.Flags().BoolVar(&watchOutputConfig.HideStreamName, "hideStreamName", false, "Hides stream name prefix")
}
